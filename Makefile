...
CFLAGS  = -O2 -g -std=c99 -fno-strict-aliasing -Wall -W -D_GNU_SOURCE -DOPENSSL_NO_ENGINE -I/usr/local/include
LDFLAGS = -static -lssl -lcrypto -lz -lev -lm -L/usr/local/lib
OBJS    = stud.o ringbuffer.o configuration.o dl.o
